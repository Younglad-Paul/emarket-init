  ...
  return (
    ...
    >
      <div className="container max-w-7xl text-center space-y-10 px-6">
        <h2 className="text-xl lg:text-3xl font-extrabold text-green-900">Need Assistance? We're Here to Help</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-10">
          <motion.div 
            className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition duration-300 ease-in-out space-y-6"
