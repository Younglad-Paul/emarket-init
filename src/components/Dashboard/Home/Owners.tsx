    ...
    <div className="w-full h-screen overflow-y-scroll p-4 pb-20">
      <section className="w-full space-y-4">
        <div className="w-full flex items-center justify-between">
          <h1 className="text-xl lg:text-3xl">Registered Owners</h1>
          <Link to="/dashboard/form" className="bg-green-900 hover:bg-green-800 p-2 text-white flex items-center justify-center rounded-md">
            <Plus />
            Register Owner
          </Link>
        </div>
        ...
        <div className="w-full flex items-center justify-end p-4 gap-4">
          ...
          <p className="bg-green-900 p-2 text-white rounded-md">8</p>
